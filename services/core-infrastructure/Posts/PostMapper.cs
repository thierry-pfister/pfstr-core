...
internal static class PostMapper
{
    public static Post ToDomain(PostEntity entity)
    {
        ...
        return new Post(
            ...
            entity.Summary,
            entity.Subtitle is null ? FSharpOption<string>.None : new FSharpOption<string>(entity.Subtitle),
            entity.Content is null ? FSharpOption<string>.None : new FSharpOption<string>(entity.Content),
            entity.CoverImage is null ? FSharpOption<string>.None : new FSharpOption<string>(entity.CoverImage),
            entity.CanonicalUrl is null ? FSharpOption<string>.None : new FSharpOption<string>(entity.CanonicalUrl),
            entity.ReadingMinutes is null ? FSharpOption<int>.None : new FSharpOption<int>(entity.ReadingMinutes.Value),
    ...
    public static PostEntity ToEntity(Post post) => new()
    {
        ...
        Subtitle = post.Subtitle is null ? null : post.Subtitle.Value,
        Content = post.Content is null ? null : post.Content.Value,
        CoverImage = post.CoverImage is null ? null : post.CoverImage.Value,
        CanonicalUrl = post.CanonicalUrl is null ? null : post.CanonicalUrl.Value,
        ReadingMinutes = post.ReadingMinutes is null ? null : post.ReadingMinutes.Value,
